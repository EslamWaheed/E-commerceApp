 ...
 * @author Hazem
 */
@WebServlet(urlPatterns = {"/ProductPlus"})
public class ProductPlus extends HttpServlet {
            ...
            if(session.getAttribute("user") == null){
                ...
                for(int i=0;i<myCart.size();i++){
                    if (myCart.get(i).getProductId() == itemId){
                        ...
                        if(quantity != myCart.get(i).getMaxQuantity()){
                            quantity++;
                        ...
                        }else if(quantity == myCart.get(i).getMaxQuantity()){
                            session.setAttribute("max", "yes");
                        }
                    }
                }
                int countPrices = 0;
