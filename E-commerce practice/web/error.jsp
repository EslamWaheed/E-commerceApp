<%-- 
    Document   : error
    Created on : Feb 16, 2018, 12:35:33 AM
    Author     : Nourhan
--%>
...
<!--===============================================================================================-->
    ...
    <body>
        <div class="container text-center">
            <div class="logo-404">
                <a href="/E-commercepractice/main.jsp"><img src="/E-commercepractice/images/logo.png" style="width: 80px;" alt="" /></a>
            </div>
            <div class="content-404">
                <img src="/E-commercepractice/images/4404.png" class="img-responsive" style="height: 330px;" alt="" />
                <h1><b>OPPS!</b> An error has occurred </h1>
                <p>Uh... So it looks like you brook something.</p>
                <h2><a href="/E-commercepractice/main.jsp" style="background-color: #17b702; color: white; height: 90px; padding: 10px;"> back to  Home</a></h2>
            </div>
        </div>
